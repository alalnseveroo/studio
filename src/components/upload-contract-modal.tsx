...
export function UploadContractModal({ isOpen, onClose, clientId, onUploadSuccess }: UploadContractModalProps) {
  ...
  const handleUpload = async () => {
    ...
    const { error: uploadError } = await supabase.storage
      .from('contracts') // Usando o bucket 'contracts' como solicitado
    ...
    if (dbError) {
      ...
      toast({
        title: 'Sucesso!',
        description: 'O contrato foi enviado com sucesso e o cliente foi ativado.',
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Upload de Contrato Externo</DialogTitle>
          <DialogDescription>
            Envie um contrato em PDF para ativar este cliente e torná-lo acessível no portal.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="py-4 space-y-4">
            <Alert>
                ...
                <AlertDescription>
                   Ao enviar um contrato, um crédito será consumido e este cliente será ativado. O contrato estará disponível no portal do cliente.
                </AlertDescription>
            </Alert>
          <div
