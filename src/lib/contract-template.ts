...
function getPrazoInfo(proposta: Proposta): string {
    let text = 'O presente contrato vigorará por prazo';
    if (proposta.contract_duration_type === 'definite') {
        ...
        text += ` determinado, pelo período de <strong>${proposta.contract_duration_months || '[Número]'} meses</strong>, com início em <strong>${startDate}</strong> e término em <strong>${endDate}</strong>, podendo ser prorrogado mediante acordo entre as partes.`;
    } else { // indefinite
        const startDate = proposta.start_date ? format(new Date(proposta.start_date), 'dd/MM/yyyy') : '[Data de Início]';
        text += ` indeterminado, a partir de <strong>${startDate}</strong>, podendo ser rescindido por qualquer uma das partes conforme a Cláusula 9ª.`;
    }
    return `<p>5.1. ${text}</p>`;
}
...
export function getContractTemplate(data: TemplateData): string {
    ...
    return `
        ...
        <h3><strong>IDENTIFICAÇÃO DAS PARTES</strong></h3>
        ...
        <h3><strong>CLÁUSULA 1ª - DO OBJETO DO CONTRATO</strong></h3>
        ...
        <h3><strong>CLÁUSULA 2ª - DAS OBRIGAÇÕES DA CONTRATADA</strong></h3>
        ...
        <h3><strong>CLÁUSULA 3ª - DAS OBRIGAÇÕES DA CONTRATANTE</strong></h3>
        ...
        <h3><strong>CLÁUSULA 6ª - DA CONFIDENCIALIDADE E PROTEÇÃO DE DADOS (LGPD)</strong></h3>
        ...
        <h3><strong>CLÁUSULA 7ª - DA PROPRIEDADE INTELECTUAL</strong></h3>
        ...
        <h3><strong>CLÁUSULA 8ª - DA INEXISTÊNCIA DE VÍNCULO EMPREGATÍCIO</strong></h3>
        ...
        <h3><strong>CLÁUSULA 9ª - DA RESCISÃO</strong></h3>
        ...
        <h3><strong>CLÁUSULA 10ª - DAS DISPOSIÇÕES GERAIS</strong></h3>
        ...
        <h3><strong>CLÁUSULA 11ª - DO FORO</strong></h3>
