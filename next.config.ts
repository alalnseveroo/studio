...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_SITE_URL: process.env.NODE_ENV === 'production' ? 'https://your-production-url.com' : 'http://localhost:9002',
    // As chaves do Asaas serão carregadas do arquivo .env e não precisam ser listadas aqui
  }
};
